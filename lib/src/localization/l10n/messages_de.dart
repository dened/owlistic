...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(dateFormatPattern) =>
      "Ungültiges Prüfungsdatumsformat!\nBitte geben Sie das Datum im Format ${dateFormatPattern} ein.";

  static m1(daysCount, attendeeNumber) =>
      "Für Benutzer ${attendeeNumber} wurden in den letzten ${daysCount} Tagen keine Ergebnisse gefunden";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
        ...
        'addPromptAttendeeNumber': MessageLookupByLibrary.simpleMessage(
            'Geben Sie Ihre 7-stellige Prüfungsteilnehmernummer ein (z.B. 0312345).'),
        'addPromptBirthDate':
            MessageLookupByLibrary.simpleMessage('Geben Sie Ihr Geburtsdatum im Format TT.MM.JJJJ ein.'),
        'addPromptExamDate':
            MessageLookupByLibrary.simpleMessage('Geben Sie Ihr Prüfungsdatum im Format TT.MM.JJJJ ein.'),
        'addSuccess': MessageLookupByLibrary.simpleMessage(
            'Informationen erfolgreich hinzugefügt!\nSie können die Liste der hinzugefügten Einträge mit /show anzeigen oder mit /add einen neuen hinzufügen.\nUm Daten zu löschen, verwenden Sie den Befehl /delete.'),
        ...
        'consentDeclinedMessage': MessageLookupByLibrary.simpleMessage(
            'Sie haben die Bedingungen abgelehnt. Um den Bot nutzen zu können, müssen Sie der Datenschutzrichtlinie zustimmen. Sie können den Bot mit /start neu starten, um die Bedingungen erneut anzuzeigen.'),
        'consentGivenMessage': MessageLookupByLibrary.simpleMessage(
            'Vielen Dank für Ihre Zustimmung! Sie können nun alle Bot-Funktionen nutzen.\nUm Ihre Prüfungsdaten hinzuzufügen, verwenden Sie den Befehl /add.'),
        ...
        'deleteCommandDescription': MessageLookupByLibrary.simpleMessage('Gespeicherte Suchdaten löschen'),
        ...
        'deleteMeCancelledMessage':
            MessageLookupByLibrary.simpleMessage('Aktion abgebrochen. Ihre Daten bleiben im System.'),
        'deleteMeCommandDescription':
            MessageLookupByLibrary.simpleMessage('Alle Ihre Daten löschen und die Einwilligung widerrufen'),
        'deleteMeConfirmationMessage': MessageLookupByLibrary.simpleMessage(
            'Sind Sie sicher, dass Sie die Einwilligung widerrufen und alle Ihre Daten aus dem System löschen möchten?'),
        'deleteMeSuccessMessage': MessageLookupByLibrary.simpleMessage(
            'Ihre Einwilligung wurde widerrufen und alle Ihre Daten wurden erfolgreich aus dem System gelöscht. Wenn Sie den Bot erneut verwenden möchten, müssen Sie den Zustimmungsvorgang erneut durchlaufen, indem Sie den Befehl /start eingeben.'),
        ...
        'deleteSelectPrompt': MessageLookupByLibrary.simpleMessage(
            'Wählen Sie einen Eintrag zum Löschen aus oder klicken Sie auf \"Alles löschen\", um alle Einträge zu entfernen.'),
        'helpCommandDescription': MessageLookupByLibrary.simpleMessage('Diese Hilfenachricht anzeigen'),
        'helpListHeader': MessageLookupByLibrary.simpleMessage('Verfügbare Befehle:'),
        ...
        'languageCommandDescription': MessageLookupByLibrary.simpleMessage('Bevorzugte Sprache einstellen'),
        'languageSelectPompt': MessageLookupByLibrary.simpleMessage(
            'Wählen Sie Ihre bevorzugte Sprache (Englisch, Deutsch, Russisch, Ukrainisch):'),
        'languageSelectedCallback': m2,
        'mustAcceptConsentMessage': MessageLookupByLibrary.simpleMessage(
            'Sie müssen der Datenschutzrichtlinie zustimmen, bevor Sie diese Funktion nutzen können. Bitte verwenden Sie den Befehl /start, um die Bedingungen erneut anzuzeigen.'),
        'privacyPolicyButtonText': MessageLookupByLibrary.simpleMessage('📄 Datenschutzrichtlinie'),
        'showCommandDescription': MessageLookupByLibrary.simpleMessage('Alle gespeicherten Suchdaten anzeigen'),
