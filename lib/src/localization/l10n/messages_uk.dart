...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'consentDeclinedMessage': MessageLookupByLibrary.simpleMessage('Ви відхилили умови. Щоб користуватися ботом, вам потрібно погодитися з Політикою конфіденційності. Ви можете перезапустити бота за допомогою команди /start, щоб знову переглянути умови.'),
    'consentGivenMessage': MessageLookupByLibrary.simpleMessage('Дякуємо за вашу згоду! Тепер ви можете використовувати всі функції бота.\nЩоб додати дані вашого іспиту, скористайтеся командою /add.'),
    ...
    'deleteMeCancelledMessage': MessageLookupByLibrary.simpleMessage('Дію скасовано. Ваші дані залишаються в системі.'),
    'deleteMeConfirmationMessage': MessageLookupByLibrary.simpleMessage('Ви дійсно бажаєте відкликати згоду та видалити всі ваші дані з системи?'),
    'deleteMeSuccessMessage': MessageLookupByLibrary.simpleMessage('Вашу згоду відкликано, а всі ваші дані успішно видалено з системи. Якщо ви захочете знову скористатися ботом, вам потрібно буде пройти процедуру згоди заново, ввівши команду /start.'),
    ...
    'mustAcceptConsentMessage': MessageLookupByLibrary.simpleMessage('Вам потрібно погодитися з Політикою конфіденційності перед використанням цієї функції. Будь ласка, скористайтеся командою /start, щоб знову переглянути умови.'),
