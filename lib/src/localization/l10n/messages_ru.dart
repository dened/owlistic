...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'consentDeclinedMessage': MessageLookupByLibrary.simpleMessage('Вы отклонили условия. Чтобы использовать бота, вам необходимо согласиться с Политикой конфиденциальности. Вы можете перезапустить бота с помощью команды /start, чтобы снова ознакомиться с условиями.'),
    'consentGivenMessage': MessageLookupByLibrary.simpleMessage('Спасибо за ваше согласие! Теперь вы можете использовать все функции бота.\nЧтобы добавить данные вашего экзамена, используйте команду /add.'),
    ...
    'deleteMeCancelledMessage': MessageLookupByLibrary.simpleMessage('Действие отменено. Ваши данные остаются в системе.'),
    'deleteMeCommandDescription': MessageLookupByLibrary.simpleMessage('Удалить все ваши данные и отозвать согласие'),
    'deleteMeConfirmationMessage': MessageLookupByLibrary.simpleMessage('Вы действительно хотите отозвать согласие и удалить все свои данные из системы?'),
    'deleteMeSuccessMessage': MessageLookupByLibrary.simpleMessage('Ваше согласие отозвано, и все ваши данные были успешно удалены из системы. Если вы захотите снова воспользоваться ботом, вам потребуется пройти процедуру согласия заново, введя команду /start.'),
    ...
    'mustAcceptConsentMessage': MessageLookupByLibrary.simpleMessage('Вам необходимо согласиться с Политикой конфиденциальности перед использованием этой функции. Пожалуйста, используйте команду /start, чтобы снова ознакомиться с условиями.'),
