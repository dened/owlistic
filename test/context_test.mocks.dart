...
// in telc_result_checker/test/context_test.dart.
...
import 'package:telc_result_checker/src/database.dart' as _i3;
import 'package:telc_result_checker/src/dto/cetrificate_entity.dart' as _i9;
import 'package:telc_result_checker/src/dto/search_info.dart' as _i8;
import 'package:telc_result_checker/src/telegram_bot/telegram_bot.dart' as _i6;
...
class _Fake$DatabaseManager_7 extends _i1.SmartFake
...
class MockDatabase extends _i1.Mock implements _i3.Database {
  ...
  @override
  _i5.Future<List<_i8.SearchInfo>> getSearchInfo(int? chatId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getSearchInfo,
          [chatId],
